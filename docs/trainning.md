...
-Try implementing it yourself without using additional gems
  -The purpose is to deepen understanding of mechanisms such as HTTP Cookies and Sessions in Rails without using Gem such as Devise
